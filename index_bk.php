...
<body>
	<div class="filter">
		<div class="container popup">
			...
			<div class="row" style="padding-top:10px">
				<div class="col-xm-12 col-md-12">
					<input id="pin" type="password" class="text-center form-control input-lg" placeholder="PIN" />
				</div>
			</div>
			<div class="row">
	...
	<div class="jumbotron">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-12"><h1>Exzy WorkingOn</h1></div>
			</div>
		</div>
	</div>
	...
	<footer class="footer">
		<div class="container">
			<p class="text-muted">Copyright © 2015 Exzy Company Limited</p>
		</div>
	</footer>
