				...
				<div class="col-xs-12 col-md-12">
					<div class="media">
						<div class="media-left media-middle">
							<img class="media-object img-circle online-img" width="96" src="images/Link_Kaew.jpg">
						</div>
						<div class="media-left media-middle">
							<img class="media-object img-circle online-img" width="96" src="images/Link_Kaew2.jpg">
						</div>
						<div class="media-left media-middle">
							<img class="media-object img-circle online-img" width="96" src="images/Link_Kaew3.jpg">
						</div>
						<div class="media-left media-middle">
							<img class="media-object img-circle online-img" width="96" src="images/Link_Kaew4.jpg">
						</div>
						<div class="media-body media-middle">
							<p>May your <strong>LOVE</strong> forever grow :)<br>
								<small class="text-muted" style="line-height:10px;" title="WeddingDay">#TariJomzupWedding</small>
							</p>
						</div>
					</div>
					<hr>
