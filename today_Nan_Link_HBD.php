				...
				<div class="col-xs-12 col-md-12">
					<div class="media">
						<div class="media-left media-middle">
							<img class="media-object img-circle online-img" width="96" src="images/Link_HBD.jpg">
						</div>
						<div class="media-left media-middle">
							<img class="media-object img-circle online-img" width="96" src="images/Nan_HBD.jpg">
						</div>
						<div class="media-body media-middle">
							<p><strong>Happy Birthday</strong> to Jomzup and Lalin<br>
								<small class="text-muted" style="line-height:10px;" title="Birthday">March 9, and March 10</small>
							</p>
						</div>
					</div>
					<hr>
